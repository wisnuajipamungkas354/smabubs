<section class="w-full p-4 md:px-12 flex flex-col gap-[5rem] md:justify-between md:gap-8">
  <div class="flex flex-col gap-4">
      ...
      <p class="mx-auto md:text-lg/8 lg:text-xl/10 text-[#727272] max-w-[100%] md:max-w-[85%] text-center dark:text-[#C3C3C3]">Profil Alumni SMA Baitul Ulya Boarding School.</p>
  </div>
